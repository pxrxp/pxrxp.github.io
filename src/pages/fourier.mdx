...
---
<br/>
### Final Formula for Taylor's Series
...
* We also **don't have a formula** for $\cos x$ or $\sin x$. That's actually what sparked the search for an approximation formula and study of Taylor's series.
...
## Taylor's Series expansion of common functions
...
If we **approximate** near **origin**, **both sides** (+x, -x) can be **equally captured**.
