...
\begin{aligned}
(a+b)^3 &= (a+b)(a+b)(a+b)\\
&= \textcolor{red}{aaa} + \textcolor{violet}{aab} + \textcolor{violet}{aba} + \textcolor{violet}{baa} + \textcolor{#FF9900}{abb} + \textcolor{#FF9900}{bab} + \textcolor{#FF9900}{bba} + \textcolor{#FF0099}{bbb}\\
&= \textcolor{red}{a^3} + \textcolor{violet}{3a^2b} + \textcolor{#FF9900}{3ab^2} + \textcolor{#FF0099}{b^3}
\end{aligned}
$$

Now, we need to **combine 3 letters**, but we only have $a$ and $b$.

At least one letter will repeat.

Let us count the no. of times one of the character appears.

We'll count $b$ (doesn't matter which you choose)
<br/>
|Letters|Count of $b$|Combinations|
|---|---|---|
|$a, a, a$|0|$a^3$|
|$a, a, b$|1|$aab, aba, baa$|
|$a, b, b$|2|$abb, bab, bba$|
